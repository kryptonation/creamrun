...
def format_driver_response(driver, has_documents = False, has_active_lease: bool = False, has_vehicle: bool = False, has_audit_trail: bool = False):
    ...
    return {
        ...
        "payee_details": {
            "pay_to_mode": "ACH" if driver.pay_to_mode and driver.pay_to_mode != "Check" else "Check",
            "data":{
            ...
            } if driver.pay_to_mode and driver.pay_to_mode != "Check" else {"bank_account_name": driver.pay_to or ""},
        },
        "lease_info": {
