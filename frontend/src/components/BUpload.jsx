...
const BUpload = ({
  ...
  // const acceptAttr =
  //   ".pdf,.jpg,.jpeg,.png,.csv,.xlsx,.xls,application/pdf,image/jpeg,image/jpg,image/png,text/csv,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel";
  // const acceptAttr =
  //   ".pdf,.jpg,.jpeg,.png,.xlsx,.xls,application/pdf,image/jpeg,image/jpg,image/png,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel";
  const acceptAttr =
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (values[variable.field_02.id].code === "others") {
        ...
        formdata.append("document_type", nameWithoutExt);
      } else {
      ...
      dispatch(setLastUploadedDocument(apiData));
      uploadDoc(formdata);
    },
  });
          ...
          {file?.name && !isAlwaysUpload ? (
            ...
            <div className="attach-con">
              <FileUpload
                ...
                invalidFileTypeMessage="Only PDF, JPG, JPEG and PNG are allowed"
                customUpload={true}
                auto
...
//             Attach Document
//             <p className="text-grey fw-small">
//               Supported formats: .pdf, .jpg and .jpeg
//             </p>
//           </div>
//         </div>
//         <Button
