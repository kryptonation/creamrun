...
@step(step_id="214", name="Fetch - Vehicle Hackup Expenses", operation="fetch")
...
@step(step_id="214", name="process -Edit Vehicle Hackup Expenses", operation="process")
def process_edit_vehicle_hackup_expenses(db, case_no, step_data):
    """
    Process the edit vehicle expenses hackup data.
    """
    try:
        logger.info("Process edit vehicle hackup expenses")
        ...
        logger.error("Error processing edit vehicle hackup expenses: %s", str(e))
        raise e
