...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('DRAFT', 'NACHA_GENERATED', 'SUBMITTED', 'PROCESSED', 'REVERSED', name='achbatchstatus'), nullable=False),
    sa.Column('total_payments', sa.Integer(), nullable=False),
    sa.Column('total_amount', sa.Numeric(precision=12, scale=2), nullable=False),
    sa.Column('nacha_file_path', sa.String(length=500), nullable=True),
    sa.Column('nacha_generated_at', sa.DateTime(), nullable=True),
    ...
    op.create_index(op.f('ix_ach_batches_id'), 'ach_batches', ['id'], unique=False)
    op.create_table('company_bank_configurations',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('company_name', sa.String(length=255), nullable=False),
    sa.Column('company_tax_id', sa.String(length=10), nullable=False),
    sa.Column('bank_name', sa.String(length=255), nullable=False),
    sa.Column('bank_routing_number', sa.String(length=9), nullable=False),
    sa.Column('bank_account_number', sa.String(length=17), nullable=False),
    sa.Column('immediate_origin', sa.String(length=10), nullable=False),
    sa.Column('immediate_destination', sa.String(length=10), nullable=False),
    sa.Column('company_entry_description', sa.String(length=10), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_company_bank_configurations_id'), 'company_bank_configurations', ['id'], unique=False)
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('dtr_number', sa.String(length=50), nullable=False),
    ...
    sa.Column('lease_id', sa.Integer(), nullable=False),
    sa.Column('primary_driver_id', sa.Integer(), nullable=False),
    sa.Column('vehicle_id', sa.Integer(), nullable=True),
    sa.Column('medallion_id', sa.Integer(), nullable=True),
    sa.Column('additional_driver_ids', sa.JSON(), nullable=True),
    sa.Column('credit_card_earnings', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('mta_fees_total', sa.Numeric(precision=10, scale=2), nullable=False),
    ...
    sa.Column('mta_fee_cbdt', sa.Numeric(precision=10, scale=2), nullable=False),
    ...
    sa.Column('is_lease_prorated', sa.Boolean(), nullable=True),
    ...
    sa.Column('prior_balance', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('subtotal_deductions', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('net_earnings', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('total_due_to_driver', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('status', sa.Enum('DRAFT', 'FINALIZED', 'PAID', name='dtrstatus'), nullable=False),
    sa.Column('payment_method', sa.Enum('ACH', 'CHECK', name='paymentmethod'), nullable=True),
    sa.Column('ach_batch_id', sa.Integer(), nullable=True),
    sa.Column('ach_batch_number', sa.String(length=50), nullable=True),
    sa.Column('check_number', sa.String(length=50), nullable=True),
    sa.Column('payment_date', sa.DateTime(), nullable=True),
    sa.Column('is_final_dtr', sa.Boolean(), nullable=True),
    sa.Column('termination_date', sa.Date(), nullable=True),
    sa.Column('cancellation_fee', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('has_pending_charges', sa.Boolean(), nullable=True),
    sa.Column('pending_charge_categories', sa.JSON(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('created_by', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['lease_id'], ['leases.id'], ),
    sa.ForeignKeyConstraint(['medallion_id'], ['medallions.id'], ),
    sa.ForeignKeyConstraint(['primary_driver_id'], ['drivers.id'], ),
    sa.ForeignKeyConstraint(['vehicle_id'], ['vehicles.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_dtrs_ach_batch_number'), 'dtrs', ['ach_batch_number'], unique=False)
    op.create_index(op.f('ix_dtrs_check_number'), 'dtrs', ['check_number'], unique=False)
    ...
    op.create_index(op.f('ix_dtrs_primary_driver_id'), 'dtrs', ['primary_driver_id'], unique=False)
    ...
    op.create_index(op.f('ix_dtrs_week_start_date'), 'dtrs', ['week_start_date'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_dtrs_week_start_date'), table_name='dtrs')
    op.drop_index(op.f('ix_dtrs_status'), table_name='dtrs')
    op.drop_index(op.f('ix_dtrs_receipt_number'), table_name='dtrs')
    op.drop_index(op.f('ix_dtrs_primary_driver_id'), table_name='dtrs')
    ...
    op.drop_index(op.f('ix_dtrs_check_number'), table_name='dtrs')
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_company_bank_configurations_id'), table_name='company_bank_configurations')
    op.drop_table('company_bank_configurations')
    op.drop_index(op.f('ix_ach_batches_id'), table_name='ach_batches')
