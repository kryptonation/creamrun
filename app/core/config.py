...
class Settings(BaseSettings):
    ...
    # Lease renewal periods (in months)
    ...
    # Lease renewal reminder period (in days)
    lease_renewal_reminder_days: int = 30

    # S3 template paths for lease renewal notifications
    admin_renewal_notification_template_key: str = "email_sms_templates/admin_renewal_notification.html"
    lease_renewal_email_template_key: str = "email_sms_templates/lease_renewal_email.html"
