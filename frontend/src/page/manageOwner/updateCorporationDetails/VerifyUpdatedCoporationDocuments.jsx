...
const VerifyUpdatedCorporationDocuments = ({
  caseId,
  currentStepId,
  reload,
  hasAccess,
  ...
  const requiredTypes = hasSignedUpdateAddress
    ? ["signed_rider_document", "ss4", "signed_update_address"]
    : ["signed_rider_document", "ss4"];
  ...
  return (
    <>
      ...
      <DocumentGridUploadAndView
        ...
        uploadFileTypes={["signed_rider_document", "signed_update_address"]}
      />
      ...
      <BSuccessMessage
        isOpen={isOpen}
        message={`${currentStep?.corporation_details?.name} Details Update is Successful `}
...
export default VerifyUpdatedCorporationDocuments;
