            ...
            for trip_node in trip_nodes:
                ...
                try:
                    ...
                    trip_data = {
                        ...
                        "start_long": Decimal(get_value(trip_node, "GPS_START_LO") or get_value(trip_node, "FromLo") or None),
                        "start_lat": Decimal(get_value(trip_node, "GPS_START_LA") or get_value(trip_node, "FromLa") or None),
                        "end_long": Decimal(get_value(trip_node, "GPS_END_LO") or get_value(trip_node, "ToLo") or None),
